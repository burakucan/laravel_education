...
class HobbyController extends Controller
{
    ...
    public function index()
    {
      //$hobbies = Hobby::all();
        ...
        $hobbies = Hobby::orderBy('created_at','DESC')->paginate();
    ...
    {
        abort_unless(Gate::allows('update' , $hobby), 403,'You are not authorized.');
    ...
    {
        abort_unless(Gate::allows('delete' , $hobby), 403,'You are not authorized.');
    ...
    public function delete_images($hobby_id){
